...
const DownloadStudentReportForm = ({ student }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await exportService.downloadStudentReport(student.studentId, selected.value, fields);
  ...
  return (
    <form className="w-full space-y-6" onSubmit={handleSubmit}>
      ...
      {/* Field Selector */}
      <FieldSelector fields={fields} setFields={setFields} title="Student Fields to Include" />
